...
export default class Create extends Component {
    ...
    onPressSave()
    {
        ...
        if(check===false)
        {
                ...
                API.createStudent(this.state.name,this.state.phone,this.state.sex,this.state.date,this.state.email)
                    .then((response) => {
    ...
    render() {
        ...
        return ( <View style={styles.container}>
            ...
            <Spinner visible={this.state.visible} textContent={"Saving..."} textStyle={{color: '#FFF'}}/>
        </View>)
    }
